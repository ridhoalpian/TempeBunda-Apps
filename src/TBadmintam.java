...
public class TBadmintam extends javax.swing.JFrame {
public DetailTB f71 = null;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btntambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 350, 50));
        ...
        getContentPane().add(btntmbhprdk, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 500, 350, 50));
        ...
        getContentPane().add(btnkembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 560, 180, 50));
        ...
        getContentPane().add(btncetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, 160, 50));
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        ...
        try {
            String sql  = "insert into trans_beli (tgl_beli, id_transbeli, id_supplier, nama_supplier, no_telp) values ('"+tanggal+"','"+txtidbeli.getText()+"','"+cmbidsup.getSelectedItem()+"','"+txtnamasup.getText()+"','"+txtnohp.getText()+"')";
            java.sql.Connection conn=(Connection)koneksi.configDB();
    ...
    private void btntmbhprdkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntmbhprdkActionPerformed
        DetailTBtam f81 = new DetailTBtam();
        ...
        f81.txtidbeli.setText(idtb);
        f81.txtidsup.setText(idsup);

        f81.setVisible(true);
        dispose();
        f81.txtidsup.requestFocus();
