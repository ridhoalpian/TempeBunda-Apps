...
public class DetailTJ1tam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnkemb1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 180, 50));
        ...
        getContentPane().add(txtkey, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 570, 440, 60));
        ...
        tabeldetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Jual", "ID Customers", "ID Produk", "Nama Produk", "Harga", "Jumlah", "Satuan", "Subtotal", "Bayar", "Kembalian"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 30, 660, 400));
        ...
        getContentPane().add(btnkemb, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 580, 160, 50));
        ...
        getContentPane().add(txtkemb, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 500, 330, 60));
        ...
        cmbprdk.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(129, 129, 129), 3, true), "ID Produk", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.ABOVE_TOP));
        ...
        getContentPane().add(txtidcus, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, 170, 60));
        ...
        getContentPane().add(txtidtrans, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 170, 60));
        ...
        getContentPane().add(txtgrndtot, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 440, 320, 60));
        ...
        getContentPane().add(txtbayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 500, 320, 60));
        ...
        getContentPane().add(btncetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 580, 210, 50));
        ...
        getContentPane().add(btnhitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 450, 330, 50));
    ...
    private void btnkemb1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnkemb1MouseEntered
        btnkemb1.setBackground(new Color(185,147,54));
        btnkemb1.setForeground(new Color(255,255,255));
    ...
    private void btnkemb1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnkemb1MouseExited
        btnkemb1.setBackground(new Color(254,211,107));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailTJ1tam().setVisible(true);
            }
        });
    }
