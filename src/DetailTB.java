...
public class DetailTB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 34, 660, 450));
        ...
        getContentPane().add(btnkemb, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 570, 170, 50));
        ...
        getContentPane().add(txtkemb, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 560, 320, 60));
        ...
        getContentPane().add(txtharga, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 350, 60));
        ...
        getContentPane().add(cmbsatuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 190, 70));

        txtidbahan.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        txtidbahan.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(129, 129, 129), 3, true), "Kode Bahan Baku", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP));
        txtidbahan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtidbahanActionPerformed(evt);
            }
        });
        getContentPane().add(txtidbahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 350, 60));
        ...
        getContentPane().add(txtsubtotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 440, 350, 60));
        ...
        getContentPane().add(txtidsup, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 80, 170, 60));
        ...
        getContentPane().add(txtgrndtot, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 500, 330, 60));
        ...
        getContentPane().add(txtbayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 500, 320, 60));
        ...
        getContentPane().add(btntmbjml, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 570, 170, 50));
        ...
        getContentPane().add(btnhitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 570, 330, 50));
        ...
        getContentPane().add(txtjumlah, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 140, 60));

        txtnamaprdk.setFont(new java.awt.Font("Century Gothic", 1, 24)); // NOI18N
        txtnamaprdk.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(129, 129, 129), 3, true), "Nama", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP));
        getContentPane().add(txtnamaprdk, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 350, 60));
        ...
        getContentPane().add(txtidbeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 170, 60));
