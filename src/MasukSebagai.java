...
public class MasukSebagai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 154, 260, 46));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 87, 260, 46));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fiksin11.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasukSebagai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
